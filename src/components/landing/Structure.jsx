            ...
            <div className="p-4">
                ...
                >
                    ...
                    >
                        ...
                        >
                            I'm a front-end web developer from Pune, blending code and creativity to craft seamless digital experiences.
                            <br />
                            <br />
                    ...
                    >
                        ...
                        <div className="grid mt-4 grid-cols-4 md:grid-cols-8 lg:grid-cols-4 gap-y-4 gap-4 justify-center w-full">
                            <a
                                href='mailto:gaurav9911093928@gmail.com'
                            ...
                            <a
                                href="https://github.com/GauravFrontend"
                                className="flex items-center justify-center aspect-square shadow-xl dark:shadow-thick hover:bg-zinc-100 dark:hover:bg-primary ring-1 bg-zinc-50 dark:ring-white/10 ring-primary/5 dark:bg-tertiary rounded-lg hover:ring-primary/5 dark:hover:ring-white/20 duration-300 group transition-all h-12 w-12"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                            ...
                            <a
                                href="https://www.linkedin.com/in/gauravwebdev/"
                                className="flex items-center justify-center aspect-square shadow-xl dark:shadow-thick hover:bg-zinc-100 dark:hover:bg-primary ring-1 bg-zinc-50 dark:ring-white/10 ring-primary/5 dark:bg-tertiary rounded-lg hover:ring-primary/5 dark:hover:ring-white/20 duration-300 group transition-all h-12 w-12"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                    ...
                    >
                        ...
                        >
                            As a frontend developer, I specialize in building captivating user interfaces that elevate digital experiences.
                            <br />
                            <br />
                        ...
                        <p className="text-primary dark:text-white mt-4">Gaurav Sharma</p>
                    </div>
                </div>
            </div>
        </section>
